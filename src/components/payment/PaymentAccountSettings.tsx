...
import { Plus, Trash2, Building, Smartphone, Banknote, CreditCard, Check, ArrowUpDown } from 'lucide-react';
import { toast } from 'sonner';
import { BusinessPayoutSettings } from './BusinessPayoutSettings';
...
export const PaymentAccountSettings: React.FC<PaymentAccountSettingsProps> = ({
  ...
  return (
    <div className="space-y-6">
      {/* Client-to-Business Payments Section */}
      {businessId && (
        <div className="space-y-4">
          <div className="flex items-center gap-2 mb-4">
            <ArrowUpDown className="w-5 h-5 text-blue-600" />
            <h3 className="text-lg font-semibold">Client-to-Business Payments</h3>
          </div>
          <BusinessPayoutSettings businessId={businessId} />
        </div>
      )}

      {/* Existing Payment Collection Section */}
      <Card>
        <CardHeader>
