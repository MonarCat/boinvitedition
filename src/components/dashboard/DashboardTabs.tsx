...
export const DashboardTabs: React.FC<Props> = ({
  handleCreateInvoice, handleViewClients, handleUpdateSettings, handleManageServices, handleSubscription, currency, navigate, showEditBusiness, setShowEditBusiness
}) => (
            ...
            {[1, 2, 3, 4].map((booking) => (
              <div key={booking} className="flex items-center justify-between p-4 border rounded-lg">
                ...
                <div className="flex items-center space-x-2">
                  <span className="bg-green-100 text-green-800 px-2 rounded">Confirmed</span>
